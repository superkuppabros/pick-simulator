...
export namespace sim {
  ...
  export const allPickDeckRange = (turn: number) =>
    simulatorSheet.getRange(11, 14, turn, 6);
  export const allEvenPickDeckRange = () =>
    simulatorSheet.getRange(11, 14, 15, 3);
  export const allOddPickDeckRange = () =>
    simulatorSheet.getRange(11, 17, 15, 3);
}
